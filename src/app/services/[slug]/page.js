...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    keywords: [
      ...
      `${service.name} manufacturer Vadodara`,
      `bulk ${service.name} order Gujarat`,
      `custom ${service.name} stitching Vadodara`,
      "bulk uniform order Gujarat",
      "Mafatlal fabric uniform",
      "Raymond fabric uniform",
      "uniform manufacturer Vadodara",
      "workwear supplier Gujarat",
    ],
