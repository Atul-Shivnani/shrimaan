            ...
            <div className="group bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@uniformco.in" className="text-lg sm:text-md text-sky-600 hover:text-sky-700 font-medium transition-colors">enquiry@shrimaanuniforms.com</a>
                </div>
              </div>
            </div>
